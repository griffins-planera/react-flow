import { _ as _slicedToArray, u as useStoreApi, a as useStore, g as getConnectedEdges, b as getDimensions, P as PanOnScrollMode, c as clamp, d as getNodesInside, e as getSelectionChanges, f as _defineProperty, h as getRectOfNodes, i as Position, C as ConnectionLineType, M as MarkerType, j as getMarkerId, k as ConnectionMode, l as getHostForElement, r as rectToBox, m as isNumeric, n as addEdge, o as Provider$1, p as createStore, q as applyEdgeChanges, s as applyNodeChanges } from './index-a7b68138.js';
export { B as BackgroundVariant, C as ConnectionLineType, k as ConnectionMode, M as MarkerType, P as PanOnScrollMode, i as Position, n as addEdge, q as applyEdgeChanges, s as applyNodeChanges, g as getConnectedEdges, x as getIncomers, w as getOutgoers, h as getRectOfNodes, z as getTransformForBounds, v as isEdge, t as isNode, y as updateEdge, a as useStore, u as useStoreApi } from './index-a7b68138.js';
import { _ as _toConsumableArray, a as _objectWithoutProperties, u as useReactFlow } from './useReactFlow-81249015.js';
export { u as useReactFlow } from './useReactFlow-81249015.js';
import React__default, { useState, useRef, useMemo, useEffect, memo, useCallback, createContext, forwardRef, useContext } from 'react';
...
var UserSelection = /*#__PURE__*/memo(function (_ref) {
  ...
  var onMouseMove = function onMouseMove(event) {
    ...
    var nextUserSelectRect = _objectSpread$a(_objectSpread$a({}, userSelectionRect), {}, {
...
var EdgeText = function EdgeText(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("g", _objectSpread$9({
...
var ConnectionLine = (function (_ref) {
  ...
  if (connectionLineType === ConnectionLineType.Bezier) {
    ...
    dAttr = getSmoothStepPath(_objectSpread$8(_objectSpread$8({}, pathParams), {}, {
      borderRadius: 0
    }));
...
var StepEdge = /*#__PURE__*/memo(function (props) {
  return /*#__PURE__*/React__default.createElement(SmoothStepEdge, _objectSpread$6(_objectSpread$6({}, props), {}, {
    borderRadius: 0
  }));
});
...
function Viewport(_ref) {
  var children = _ref.children;
  var transform = useStore(selector$4);
  return /*#__PURE__*/React__default.createElement("div", {
...
var Handle = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var onConnectExtended = useCallback(function (params) {
    ...
    var edgeParams = _objectSpread$4(_objectSpread$4({}, defaultEdgeOptions), params);
  ...
  return /*#__PURE__*/React__default.createElement("div", _objectSpread$4({
...
function SelectionListener(_ref) {
  ...
  var _useStore = useStore(selector, areEqual),
      selectedNodes = _useStore.selectedNodes,
...
export { BezierEdge, EdgeText$1 as EdgeText, Handle$1 as Handle, ReactFlowProvider, SmoothStepEdge, StepEdge, StraightEdge, ReactFlow as default, getBezierPath, getCenter as getEdgeCenter, getMarkerEnd, getSmoothStepPath, useEdgesState, useKeyPress, useNodesState };
